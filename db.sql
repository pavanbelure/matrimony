...
-- Dumping structure for table quiz_db.tbl_items
...
-- Dumping data for table quiz_db.tbl_items: 2 rows
...
REPLACE INTO `tbl_items` (`itemId`, `itemHeader`, `itemSub`, `itemDesc`, `itemImage`, `isDeleted`, `createdBy`, `createdDtm`, `updatedDtm`, `updatedBy`) VALUES
	...
	(2, 'CodeIgniter User Management', 'Demo for user management system', 'This the demo of User Management System (Admin Panel) using CodeIgniter PHP MVC Framework and AdminLTE bootstrap theme. You can download the code from the repository or forked it to contribute. Usage and installation instructions are provided in ReadMe.MD', 'quiz_db.png', 0, 1, '2015-09-02 00:00:00', NULL, NULL);
/*!40000 ALTER TABLE `tbl_items` ENABLE KEYS */;

-- Dumping structure for table quiz_db.tbl_reset_password
...
-- Dumping data for table quiz_db.tbl_reset_password: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_reset_password` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_reset_password` ENABLE KEYS */;

-- Dumping structure for table quiz_db.tbl_roles
...
-- Dumping data for table quiz_db.tbl_roles: 3 rows
...
-- Dumping structure for table quiz_db.tbl_users
...
-- Dumping data for table quiz_db.tbl_users: 3 rows
